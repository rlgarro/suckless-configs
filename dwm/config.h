...
static const char *fonts[]          = {"Hack Nerd Font Mono:style=Bold:pixelsize=13"};
static const char dmenufont[]       = "Hack Nerd Font Mono:style=Bold:pixelsize=13";
...
static const char *layout_change[]  = { "st", "-e", "layout_change" };
static const char *de[]  = { "de", NULL };
static const char *us[]  = { "us", NULL };
static const char *es[]  = { "es", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_c,      spawn,          {.v = layout_change } },
	...
	{ MODKEY|ShiftMask,             XK_b,      spawn,          {.v = de } },
	{ MODKEY|ShiftMask,             XK_n,      spawn,          {.v = es } },
	{ MODKEY|ShiftMask,             XK_m,      spawn,          {.v = us } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
